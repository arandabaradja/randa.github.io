...
<body>
    ...
    <div class="col-md-10 p-5 pt-2">
        ...
        <hr>
        <a href="tambahjadwalkuliah.php" class="btn btn-primary mb-2">
        ...
        <table class="table table-striped table-bordered">
          ...
          include 'koneksi.php';
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM jadwal_kuliah");
              $no = 1;
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="ubah_jadwalkuliah.php?kode_matakuliah=<?php echo $data['kode_matakuliah'];?>">Edit</a>
                    <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                    <a href="hapus_jadwalkuliah.php?kode_matakuliah=<?php echo $data['kode_matakuliah'];?>">Delete</a>
                </td>
            </tr>
            <?php
          }
