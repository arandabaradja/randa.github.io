...
<body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <hr>
            <form action="simpan_jadwalmatakuliah.php" method="post">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>HARI</label>
                        <input type="text" name="hari" class="form-control" id="nama">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>JAM MULAI</label>
                        <input type="time" name="jam_mulai" class="form-control" id="alamat">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>JAM SELESAI</label>
                        <input type="time" name="jam_selesai" class="form-control" id="alamat">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>MATAKULIAH</label>
                        <input type="text" name="nama_matakuliah" class="form-control" id="alamat">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
